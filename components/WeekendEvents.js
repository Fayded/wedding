  ...
  return (
    <section className="weekendEvents">
      <section className="container justify-center items-center grid grid-cols-1 md:grid-cols-12">
        ...
        <p className="mb-14 col-span-12 md:col-span-8 md:col-start-3 text-center"><span className="mx-4">The Wedding Night</span>|<span className="mx-4">March 16th, 2024</span>|<span className="mx-4">Gowns &amp; Tuxes</span></p>
      </section>
      ...
      <section className="container">
      <p className="text-xl my-10 col-span-12 md:col-span-8 col-start-3 text-center"><span className="mr-4">The Night Before</span>|<span className="mx-4">March 15th, 2024</span>|<span className="mx-4">Cocktail Attire</span></p>
      </section>
