  ...
  return (
    <section className="toStay">
      <section className="container justify-center items-center grid grid-cols-12">
        ...
        <p className="mb-14 col-span-6">Guests are highly encouraged to book hotel reservations as soon as possible. Room blocks have been reserved for our guests at a discounted rate. Click the respective links below to secure your ATL stay.</p>
      </section>
      <section className="grid grid-cols-6 gap-16 items-center container">
        ...
        <section className="col-span-2 mb-16">
          ...
          <p>A Luxurious, Regal Hotel - A Marriott Property</p>
        ...
        <section className="container justify-center grid grid-cols-12 gap-16">
          <section className="col-span-6">
            ...
            <p>An Urban, Boutique Hotel - A Hyatt Property</p>
          ...
          <section className="col-span-6">
            ...
            <p>A Mid-Century, Chic Hotel - An IHG Property</p>
