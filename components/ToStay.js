  ...
  return (
    <section className="toStay">
      ...
      <section className="grid grid-cols-1 md:grid-cols-6 gap-0 md:gap-16 items-center container">
        ...
        <section className="col-span-12 md:col-span-2 mb-8 md:mb-16">
          <h1 className="text-base md:text-xl mt-6 mb-4"><a href="https://www.marriott.com/en-us/hotels/atlxr-the-st-regis-atlanta/overview/?scid=f2ae0541-1279-4f24-b197-a979c79310b0" target='_blank'>The St. Regis</a></h1>
          <p className="text-sm md:text-base mb-2">A Luxurious, Regal Hotel - A Marriott Property</p>
          <p className="text-sm md:text-base">The location of the wedding celebration, guests are highly encouraged to stay at this landmark hotel. Top-ranked The St. Regis Atlanta towers over Buckhead, a city dubbed &apos;The Beverly Hills of the South&apos;. Its impressive European-style architecture, fine custom furnishings and décor, top of the line amenities and impeccable first-class service set a new standard for luxury in Atlanta.</p>
          <a href="https://www.marriott.com/event-reservations/reservation-link.mi?id=1678224045654&key=GRP&app=resvlink" target='_blank' className="my-4 flex items-center text-sm md:text-base">Reserve the block rate &nbsp; <HiOutlineChevronRight /></a>         
        </section>
        </section>
        <section className="container justify-center grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-16">
          <section className="col-span-12 md:col-span-6 mb-8 md:mb-16">
            <Image
              src="/thompson.jpg"
              alt="The Thompson"
              width={608}
            ...
            <h1 className="text-base md:text-xl mt-6 mb-4"><a href="https://www.hyatt.com/thompson-hotels/en-US/atlth-thompson-atlanta-buckhead/?src=corp_lclb_gmb_seo_atlth" target='_blank'>The Thompson</a></h1>
            <p className="text-sm text-base mb-2">An Urban, Boutique Hotel - A Hyatt Property</p>
            <p className="text-sm md:text-base">Design meets urban luxury at this boutique Buckhead hotel. Thompson Buckhead is an urban retreat that seamlessly blends modern innovation and influential design. Take in a new view of the Atlanta skyline at the rooftop pool deck, outfitted with private cabanas, mingle over cocktails in our jewel box lobby bar, and indulge in classic Italian-American cuisine from a James Beard nominated chef.</p>
            <a href="https://www.hyatt.com/en-US/group-booking/ATLTH/G-HID0" target='_blank' className="my-4 flex items-center text-sm md:text-base">Reserve the block rate &nbsp; <HiOutlineChevronRight /></a>         
          </section>
          <section className="col-span-12 md:col-span-6 mb-8 md:mb-16">
            <Image
              src="/kympton.jpg"
              ...
              height={370}
            />
            <h1 className="text-base md:text-xl mt-6 mb-4"><a href="https://www.thesylvanhotel.com/?&utm_source=Google%20My%20Business&utm_medium=organic&utm_campaign=GMB&utm_term=the%20sylvan" target='_blank'>The Kimpton Sylvan</a></h1>
            <p className="text-sm text-base mb-2">A Mid-Century, Chic Hotel - An IHG Property</p>
            <p className="text-sm md:text-base">An unexpected oasis tucked away in Atlanta’s posh Buckhead area. Mid-century style and modern-chic design cavort effortlessly throughout the space, from the supper club-style restaurant to the cheeky rooftop bar. Outside, nearly 5,000 square feet of gardens lure you with hidden nooks, plus a sparkling pool. Here, just steps from high-style shopping, dining, galleries and nightlife, Georgia hospitality is warm and estive all at once.</p>
            <a href="https://www.kimptonhotels.com/redirect?path=asearch&brandCode=KI&localeCode=en&regionCode=1&hotelCode=ATLKM&checkInDate=14&checkInMonthYear=022024&checkOutDate=18&checkOutMonthYear=022024&rateCode=6CBARC&_PMID=99801505&GPC=SEN&cn=no&viewfullsite=true" target='_blank' className="my-4 flex items-center text-sm md:text-base">Reserve the block rate &nbsp; <HiOutlineChevronRight /></a>
          </section>
        </section>
    </section>
  )
