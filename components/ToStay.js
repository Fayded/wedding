  ...
  return (
    <section className="toStay">
      <section className="container justify-center items-center grid grid-cols-1 md:grid-cols-12 mb-5 md:mb-0">
        ...
        <p className="mb-2 md:mb-14 col-span-12 md:col-span-12 text-center">Guests are highly encouraged to book hotel reservations as soon as possible. <br />Room blocks have been reserved for guests at a discounted rate. Click the respective links below to secure an ATL stay.</p>
      </section>
