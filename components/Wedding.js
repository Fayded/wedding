      ...
      <section className="container justify-center grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-16">
        <section className="col-span-6 mb-16">
          <Image
            ...
            height={500}
          />
          <h1 className="text-base md:text-xl mt-6 mb-2">The Ceremony</h1>
          <p className="text-sm md:text-base">Gowns and Tuxes</p>
          <p className="text-sm md:text-base">6:00pm Ceremony at Cathedral of Christ the King.</p>
        </section>
        <section className="col-span-6 mb-16">
          <Image
            src="/kympton.jpg"
